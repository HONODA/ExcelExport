...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.Suplierlist.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        ...
        self.search_suplier.setGeometry(QtCore.QRect(223, 45, 171, 24))
        self.search_suplier.setObjectName("search_suplier")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(140, 47, 91, 20))
